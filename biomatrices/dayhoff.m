function [matrix, matrixInfo] = dayhoff
%DAYHOFF returns Dayhoff's original PAM-250 substitution matrix.
%   Expected score = -0.8644, Entropy = 0.4456 bits
%   Lowest score = -8, Highest score = 17
%
%   Order:
%   A  R  N  D  C  Q  E  G  H  I  L  K  M  F  P  S  T  W  Y  V  B  Z  X  *
%
%   [MATRIX,MATRIXINFO] = DAYHOFF returns a structure of information about
%   the matrix with fields Name, Scale, Entropy, ExpectedScore, LowestScore,
%   HighestScore and Order.
%
%   See also BLOSUM, GONNET, PAM.
...
if nargout >1
    matrixInfo.Name = 'DAYHOFF';
    matrixInfo.Scale = 1/3;
    matrixInfo.Entropy = 0.4456;
    matrixInfo.ExpectedScore = -0.8644;
